          ...
          <div className="p-6">
            ...
            {(status === 'disconnected' || status === 'unknown') && (
              <button 
                ...
                className="w-full py-3 px-4 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-all flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {whatsappMutation.isPending ? 'Requesting Connection...' : 'Connect WhatsApp Device'}
              </button>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 text-center">
              ...
              <button 
                ...
                className="mt-6 w-full py-2.5 px-4 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium rounded-lg transition-colors"
              >
                Cancel
              </button>
            </div>
